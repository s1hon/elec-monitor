<template>
  <div>
    <span><input class="input" size="10" type="text" @click.stop="open($event,'fromDate')" v-model="$store.state.calendar.items.fromDate.value"></span>
    <span><input class="input" size="10" type="text" @click.stop="open($event,'toDate')" v-model="$store.state.calendar.items.toDate.value"></span>
